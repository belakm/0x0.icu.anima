...
export const createScrollbars = (variant = 'default') => css`
  ...
  ::-webkit-scrollbar-track {
    ${({ theme }) =>
      createHatchedBackground({
        mainColor: theme.system.material,
        secondaryColor: theme.system.borderLightest,
      })}
  }
  ...
  ::-webkit-scrollbar-button:horizontal:decrement {
    background-image: ${({ theme }) =>
      createTriangleSVG(theme.system.materialText, 90)};
  }
  ::-webkit-scrollbar-button:horizontal:increment {
    background-image: ${({ theme }) =>
      createTriangleSVG(theme.system.materialText, 270)};
  }
  ::-webkit-scrollbar-button:vertical:decrement {
    background-image: ${({ theme }) =>
      createTriangleSVG(theme.system.materialText, 180)};
  }
  ::-webkit-scrollbar-button:vertical:increment {
    background-image: ${({ theme }) =>
      createTriangleSVG(theme.system.materialText, 0)};
  }
`
